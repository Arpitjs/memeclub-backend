...
router.post('/followFollowing', authController.protect, userController.followFollowingUser)
router.post('/UnfollowFollowing', authController.protect, userController.UnfollowFollowingUser)
